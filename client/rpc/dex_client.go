...
type DexClient interface {
	...
	SignHTLT(recipient types.AccAddress, recipientOtherChain, senderOtherChain string, randomNumberHash []byte, timestamp int64,
		amount types.Coins, expectedIncome string, heightSpan int64, crossChain bool, syncType SyncType, options ...tx.Option) ([]byte, error)
...
func (c *HTTP) SignHTLT(recipient types.AccAddress, recipientOtherChain, senderOtherChain string, randomNumberHash []byte, timestamp int64,
	amount types.Coins, expectedIncome string, heightSpan int64, crossChain bool, syncType SyncType, options ...tx.Option) ([]byte, error) {
	if c.key == nil {
		return nil, KeyMissingError
	}
...
func (c *HTTP) sign(m msg.Msg, options ...tx.Option) ([]byte, error) {
	...
	databytes, _ := json.Marshal(signMsg)
